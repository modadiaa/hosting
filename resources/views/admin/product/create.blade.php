...
<legend>Form Title</legend>
    ...
    <input type="text" class="form-control" name="pro_name" id="pro_name" placeholder="Input ....">
...
<div class="form-group {{$errors->has('pro_price')? 'has-error':''}}" >
    ...
    <input type="text" class="form-control" name="pro_price" id="pro_price" placeholder="Input ....">
    <span class="text-danger">{{$errors->first('pro_price')}}</span>
</div>

<div class="form-group {{$errors->has('stock')? 'has-error':''}}" >
    <label for="stock"> Stock </label>
    <input type="text" class="form-control" name="stock" id="stock" placeholder="Input ....">
    <span class="text-danger">{{$errors->first('stock')}}</span>
</div>

<div class="form-group {{$errors->has('pro_info')? 'has-error':''}}" >
    <label for="pro_info"> Describtion </label>
...
<div class="form-group {{$errors->has('spl_price')? 'has-error':''}}" >
    ...
    <input type="text" class="form-control" name="spl_price" id="spl_price" placeholder="Input ....">
